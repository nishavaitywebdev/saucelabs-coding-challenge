...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentWillMount() {
            ...
            (0, _isomorphicFetch2.default)('getPlotPoints', opts).then(function (response) {
                return response.json();
            }).then(function (jsonResponse) {
                _this2.setState({ plotPoints: jsonResponse.plotPoints });
            });
        }
    }, {
        key: 'render',
...
var _highcharts = __webpack_require__(35);
...
var Chart = function (_Component) {
    ...
    function Chart() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Chart.__proto__ || Object.getPrototypeOf(Chart)).call.apply(_ref, [this].concat(args))), _this), _this.getSeriesData = function (data) {
            var seriesData = [];
            var passData = {},
                errorData = {},
                failData = {};
    ...
    _createClass(Chart, [{
        ...
        key: 'render',
        value: function render() {
            return _react2.default.createElement('div', { className: '', id: this.props.visualizationId });
        }
    }]);
...
Chart.propTypes = {
    ...
    visualizationId: _propTypes2.default.string
};
